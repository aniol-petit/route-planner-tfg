...
def build_graph():
    ...
    airports_df = pd.read_csv(PROJECT_ROOT / "data" / "final_data" / "airports_df.csv")
    ...
    flights_df = pd.read_csv(PROJECT_ROOT / "data" / "final_data" / "flights_df.csv")
    ...
    routes_df = pd.read_csv(PROJECT_ROOT / "data" / "final_data" / "routes_df.csv")
    station_countries = {}
    ...
    connections_df = pd.read_csv(PROJECT_ROOT / "data" / "final_data" / "connections.csv")
...
if __name__ == "__main__":
    ...
    with open(PROJECT_ROOT / "graph" / "transportation_graph.gpickle", 'wb') as f:
        pickle.dump(graph, f)
    ...
    # nx.write_graphml(graph, PROJECT_ROOT / "data" / "final_data" / "transportation_graph.graphml")

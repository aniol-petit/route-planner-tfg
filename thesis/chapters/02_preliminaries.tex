...
\begin{figure}[htbp]
  ...
  \begin{minipage}[t]{0.46\textwidth}
    ...
    \end{tikzpicture}
    \par\medskip
    {\small\textbf{(a)}~$G=(V,E)$ with $V=\{u,v,w,x\}$ and $E=\{(u,v),(v,w),\ldots\}$.}
  \end{minipage}\hfill
  ...
  \end{minipage}
  \caption{Panel~(a) shows the abstract structure $G=(V,E)$; panel~(b) shows directed edges $e=(u,v)$ and $e=(v,w)$ whose labels denote travel time in minutes, i.e.\ $w(u,v)=95$ and $w(v,w)=40$.}
